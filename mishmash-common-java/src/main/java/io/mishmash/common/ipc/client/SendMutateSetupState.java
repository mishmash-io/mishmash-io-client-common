...
/**
 * A GRPC stream state that sends a SETUP message for a MUTATE stream.
 *
 * @param <MT> - the type of {@link Mishmash} class that will be built
 */
public abstract class SendMutateSetupState<MT extends Mishmash<Key, Value>>
        extends SendSetupState<
